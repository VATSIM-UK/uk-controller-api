 ...
 */
class OperationsContributorPolicy
{
    use ChecksUserRoles;
    use HandlesAuthorization;

    private const EDITING_ROLES = [RoleKeys::DIVISION_STAFF_GROUP, RoleKeys::WEB_TEAM, RoleKeys::OPERATIONS_TEAM, RoleKeys::OPERATIONS_CONTRIBUTOR];
