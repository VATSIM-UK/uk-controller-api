...
class UserResourceTest extends BaseFilamentTestCase
{
    ...
    {
        Livewire::test(Users\Pages\ViewUser::class, ['record' => self::BANNED_USER_CID])
    ...
    {
        Livewire::test(Users\Pages\EditUser::class, ['record' => self::BANNED_USER_CID])
            ->assertSet('data.first_name', 'User')
            ->assertSet('data.last_name', 'Banned')
            ->assertSet('data.status', 2);
    }
    ...
    public function testItListsRoles()
    {
        ...
        Livewire::test(
            Users\RelationManagers\RolesRelationManager::class,
