...
class DeleteUserTokensTest extends BaseFunctionalTestCase
{
    ...
    {
        $return = Artisan::call(self::ARTISAN_COMMAND, ['vatsim_cid' => 'foo']);
    ...
    {
        $return = Artisan::call(self::ARTISAN_COMMAND, ['vatsim_cid' => '666']);
    ...
    public function testItDeletesAllUserTokens()
    {
        ...
        $return = Artisan::call(self::ARTISAN_COMMAND, ['vatsim_cid' => '1203533']);
