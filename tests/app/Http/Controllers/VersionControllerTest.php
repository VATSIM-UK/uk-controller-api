            ...
            ->assertJson(
                [
                    [
                        ...
                        'version' => '1.0.0',
                        'allowed' => false,
                        'created_at' => '2017-12-02T00:00:00.0000001',
                    ...
                    [
                        ...
                        'version' => '2.0.0',
                        'allowed' => true,
                        'created_at' => '2017-12-03T00:00:00.000002Z',
                        'updated_at' => null,
                    ],
                    [
                        'id' => 3,
                        'version' => '2.0.1',
                        'allowed' => true,
                        'created_at' => '2017-12-04T00:00:00.000003Z',
                        'updated_at' => null,
                    ],
                ]
            )->assertStatus(200);
        ...
        $this->makeAuthenticatedApiRequest(self::METHOD_GET, 'version/1.0.0')
            ->assertJson(
                [
                    ...
                    'allowed' => false,
                    'created_at' => '2017-12-02T00:00:00.0000001',
                    'updated_at' => '2017-12-03T00:00:00.0000002',
                ]
            )->assertStatus(200);
    }
