...
class PrenoteAcknowledgedEventTest extends BaseUnitTestCase
{
    private PrenoteMessage $message;
    private PrenoteAcknowledgedEvent $event;
    ...
    public function setUp(): void
    {
        ...
        $this->message->id = 55;
        $this->event = new PrenoteAcknowledgedEvent($this->message);
    }
    ...
    {
        $this->assertEquals('prenote-message.acknowledged', $this->event->broadcastAs());
    }
