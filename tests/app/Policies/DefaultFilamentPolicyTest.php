...
class DefaultFilamentPolicyTest extends BaseFunctionalTestCase
{
    ...
    public function dataProvider(): array
    {
        return [
            ...
            'Force Delete Any Operations' => ['forceDeleteAny', RoleKeys::OPERATIONS_TEAM, true],
            'Force Delete Any Web' => ['forceDeleteAny', RoleKeys::WEB_TEAM, true],
            'Force Delete Any DSG' => ['forceDeleteAny', RoleKeys::DIVISION_STAFF_GROUP, true],
