...
class DefaultFilamentPolicyTest extends BaseFunctionalTestCase
{
    ...
    public static function dataProvider(): array
    {
        return [
            ...
            'Mobe Up Operations Contributor' => ['moveUp',  RoleKeys::OPERATIONS_CONTRIBUTOR, false],
            ...
            'Move Down Operations Contributor' => ['moveDown',  RoleKeys::OPERATIONS_CONTRIBUTOR, false],
