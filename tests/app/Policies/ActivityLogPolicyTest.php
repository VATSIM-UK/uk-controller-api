...
class ActivityLogPolicyTest extends BaseFunctionalTestCase
{
    ...
    public static function dataProvider(): array
    {
        return [
            ...
            'Update Any Operations Contributor' => ['update',RoleKeys::OPERATIONS_CONTRIBUTOR, false],
            ...
            'Delete Any Operations Contributor' => ['delete',RoleKeys::OPERATIONS_CONTRIBUTOR, false],
